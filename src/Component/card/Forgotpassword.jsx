            ...
            <div className="w-full max-w-6xl flex flex-col md:flex-row bg-white shadow-xl rounded-2xl overflow-hidden">
                <div className="w-full md:w-1/2 flex flex-col gap-[30px] md:gap-3 pt-[54px] pb-[100px] pl-[60px]">
                    <div className="">
                        ...
                        <h2 className="text-2xl font-bold pt-[22px]">Forgot password?</h2>
                    </div>

                    <div className="flex flex-col gap-3.5 ">
                        <h1 className='font-inter font-medium text-xl leading-[130%]'>Phone number.</h1>
                        <input
                            type="number"
                    ...
                    <div className="flex flex-col gap-3.5 ">
                            <h1 className='font-inter font-medium text-xl leading-[130%]'>Enter OTP</h1>
                        <div className="relative">
                            <input type={ShowOtp ? "text" : "Otp"}
                                placeholder="OTP"
                                className="w-full outline-none rounded px-4 py-2 bg-lite-gray font-inter font-medium text-sm leading-[130%]" />
                            <div className="absolute right-3 top-1/4 cursor-pointer" onClick={() => SetshowOtp(!ShowOtp)}>
